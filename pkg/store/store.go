...
import (
	...
	accountingtaskref "github.com/dwarvesf/fortress-api/pkg/store/accountingtaskref"
...
type Store struct {
	...
	AccountingTaskRef       accountingtaskref.IStore
...
func New() *Store {
	return &Store{
		...
		AccountingTaskRef:       accountingtaskref.New(),
