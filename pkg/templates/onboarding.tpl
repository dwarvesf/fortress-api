...
<div dir=3D"ltr">
	<div>Hi <b>{{.Fullname}}</b>,<div>
			<div dir=3D"ltr">
				<div><br></div>
				<div>Your onboarding process has been succeed. You are now a {{.Role}} at
					Dwarves Foundation. Please verify your Dwarves and Basecamp account, please login your work email:<br><br>
