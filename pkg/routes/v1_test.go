...
func Test_loadV1Routes(t *testing.T) {
	expectedRoutes := map[string]map[string]gin.RouteInfo{
		...
		"/cronjobs/notify-monthly-memos": {
			"POST": {
				Method:  "POST",
				Handler: "github.com/dwarvesf/fortress-api/pkg/handler/discord.IHandler.NotifyMonthlyMemos-fm",
			},
		},
		...
		"/webhooks/nocodb/accounting": {
			"POST": {
				Method:  "POST",
				Handler: "github.com/dwarvesf/fortress-api/pkg/handler/webhook.IHandler.StoreNocoAccountingTransaction-fm",
			},
		},
		"/webhooks/nocodb/expense": {
			"POST": {
				Method:  "POST",
		...
		"/webhooks/notion": {
			"POST": {
				Method:  "POST",
				Handler: "github.com/dwarvesf/fortress-api/pkg/handler/webhook.IHandler.HandleNotionLeave-fm",
			},
		},
		"/webhooks/notion/refund": {
			"POST": {
				Method:  "POST",
				Handler: "github.com/dwarvesf/fortress-api/pkg/handler/webhook.IHandler.HandleNotionRefund-fm",
			},
		},
		"/webhooks/notion/onleave": {
			"POST": {
				Method:  "POST",
		...
		"/webhooks/notion/invoice/send": {
			"POST": {
				Method:  "POST",
				Handler: "github.com/dwarvesf/fortress-api/pkg/handler/webhook.IHandler.HandleNotionInvoiceSend-fm",
			},
		},
		...
		"/api/v1/invoices/contractor/generate": {
			"POST": {
				Method:  "POST",
...
func (m *mockContractorPayablesController) PreviewCommitByFile(ctx context.Context, fileName string, year int) (*contractorpayables.PreviewCommitResponse, error) {
	return nil, nil
}
