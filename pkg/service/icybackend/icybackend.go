...
const (
	ICYBTCSwapAddress = "0x175c2adA4a0b1AC1cc9717F4E47b6868332bad76"
	IcyTokenAddress   = "0x5233E10cc24736F107fEda42ff0157e91Cf1F8b6"
)
...
func (i *icybackend) Swap(signature model.GenerateSignature, btcAddress string) (*model.SwapResponse, error) {
	...
	privateKey, err := crypto.HexToECDSA(i.cfg.IcyBackend.PrivateKey)
	if err != nil {
