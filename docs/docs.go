...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "Invoice": {
            ...
            "properties": {
                ...
                "lineItems": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github.com_dwarvesf_fortress-api_pkg_view.InvoiceItem"
                    }
                },
                "month": {
                    "type": "integer"
        ...
        "SendInvoiceRequest": {
            ...
            "properties": {
                ...
                "lineItems": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github.com_dwarvesf_fortress-api_pkg_handler_invoice_request.InvoiceItem"
                    }
                },
                "note": {
                    "type": "string"
        ...
        "github.com_dwarvesf_fortress-api_pkg_handler_invoice_request.InvoiceItem": {
            "type": "object",
            "properties": {
                "cost": {
                    "type": "number"
        ...
        "github.com_dwarvesf_fortress-api_pkg_view.InvoiceItem": {
            "type": "object",
            "properties": {
                "cost": {
                    "type": "number"
        ...
        "model.Employee": {
            ...
            "properties": {
                ...
                "employeeMMAScores": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.EmployeeMMAScore"
                    }
                },
