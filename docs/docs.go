...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/dashboards//work-unit-distribution": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/view.WorkUnitDistributionResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "view.WorkUnitDistributionData": {
            ...
            "properties": {
                ...
                "workunits": {
                    "$ref": "#/definitions/view.WorkUnitData"
                }
            }
        },
        "view.WorkUnitDistributionDataList": {
            "type": "object",
            "properties": {
                "total": {
                    "$ref": "#/definitions/view.WorkUnitData"
        ...
        "view.WorkUnitDistributionResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/view.WorkUnitDistributionDataList"
                }
            }
        },
